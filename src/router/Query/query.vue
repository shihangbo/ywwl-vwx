<template>
	<div class="page query">
		<div class="query-msg-fixed bg-white bbh text-left">
			<div class="query-id pl10"><span>燕文物流单号</span><span>{{queryId}}</span></div>
			<div class="query-msg-fixed__item">
				<p class="w50 cut fl c0"><span>信息:</span><span>{{stateStr}}</span></p>
				<p class="w50 cut fl c0"><span>时间:</span><span>{{timeStr}} 天</span></p>
			</div>
			<div class="query-msg-fixed__item">
		...
		<div class="text-left query-msg-content">
			<p class="fs18 c0 mt20" style="padding-left:.5rem;margin-bottom:-10px;"><icon style="vertical-align: sub;" type="download"></icon>目的国: <span class="label-warn__sm">{{destinCountry}}</span></p>
			<timeline>
			...
			<p class="fs18 c0 mt20" style="padding-left:.5rem;margin-bottom:-10px;"><icon style="vertical-align: sub;" type="download"></icon>发件国: <span class="label-primary__sm">{{originCountry}}</span></p>
			<timeline>
